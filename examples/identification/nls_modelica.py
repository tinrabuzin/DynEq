'''
Parameter identification for Modelica models with nonlinear least squares. 
'''
import sys
sys.path.append('.')
...
x0 = [0.04,1e-3, -0.001, 0, 1, 0.95, 1.05, 0.9, 0.91, 0.998, 0.999, 1.005, 1.01, 0.02]
ident_opts = {'x0':x0, 'method':'trf', 'tr_solver':'exact', 
              'verbose':2, 'bounds':(lb,ub), 'jac':'2-point'}
